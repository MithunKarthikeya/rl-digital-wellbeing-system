...
from app_usage_environment import AppUsageControlEnvironment

def train_app_usage_control():
    """Train both Q-Learning and DQN agents for App Usage Control"""
    
    print("🚀 Starting App Usage Control System Training...")
    ...
    # Create environment
    env = AppUsageControlEnvironment(user_profiles)
    ...
    plot_training_results(agents, os.path.join(os.path.dirname(current_dir), 'results/app_usage_control_training.png'))
    
    # Save models
    print("\n💾 Saving models...")
    dqn_agent.save_model(os.path.join(os.path.dirname(current_dir), 'results/models/app_usage_control_dqn_model.pth'))
    
    # Save training data
    np.save(os.path.join(os.path.dirname(current_dir), 'results/models/app_usage_control_q_rewards.npy'), q_rewards)
    np.save(os.path.join(os.path.dirname(current_dir), 'results/models/app_usage_control_dqn_rewards.npy'), dqn_rewards)
    
    # Test with specific scenarios
    print("\n🧪 Testing specific scenarios...")
    test_scenarios(env, q_agent, dqn_agent, user_profiles)
    
    print("\n✅ App Usage Control System Training Complete!")
...
def test_scenarios(env, q_agent, dqn_agent, user_profiles):
    """Test agents with specific user scenarios"""
    ...
    for usage_type, user_id in user_types.items():
        ...
        print(f"   Final Usage Summary: {env.get_usage_summary()}")
...
if __name__ == "__main__":
    ...
    # Run training
    results = train_app_usage_control()
